...
namespace Orckestra.Analyzers.Tests.Sources
{
    public class Dummy
    {
        ...
        public async Task WaitAsync(int delay)
        {
        ...
        public async Task<int> MoreComplexAsync()
        {
        ...
        public async Task<int> MoreComplexAsync2()
        {
            ...
            return await func(42).ConfigureAwait(false);
        }
        ...
        public async Task<int> MultipleReturnAwaitAsync(bool condition)
        {
            if (condition)
                return await GetNumberAsync().ConfigureAwait(false);
